...
@section('content')
    ...
    <a id="link-add" href="{{ route('create') }}">
    ...
    <table>
        ...
        @foreach ($livros as $livro)
            <tr>
                <td class="border-table">{{ $livro->title }}</td>
                <td class="border-table">{{ $livro->author }}</td>
                <td class="border-table">{{ $livro->year }}</td>
                <td class="border-table">{{ $livro->publisher }}</td>
                <td class="filters">
                    <a href="{{ route('show', $livro->id) }}">
                    ...
                    <form action="{{ route('destroy', $livro->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
